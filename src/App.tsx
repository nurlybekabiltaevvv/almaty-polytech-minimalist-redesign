...
const newsItems = [
  {
    ...
    desc: 'Посетите колледж, познакомьтесь с программами обучения и преподавателями.',
  },
  {
    category: 'Обновление',
    title: 'Новые образовательные программы',
    desc: 'Учебные планы адаптированы под запросы современных работодателей.',
  },
  {
    category: 'Партнёрство',
    title: 'После колледжа — в вуз',
    desc: 'Поступление на льготных условиях в ведущие университеты Казахстана.',
  },
];

const partners = [
  'ҚАЗҰУ', 'ҚАЗҰТУ', 'ХҚТУ', 'Назарбаев Университеті',
  'КАУ', 'АУЭЗОВ', 'KazNPU', 'KBTU', 'КИМЭП',
  'НАРХОЗ', 'СДУ', 'ALMA', 'Туран', 'МУИТ',
  'ҚАЗГЮУ', 'АЛЕМ', 'ЦЕС', 'Болашақ', 'Каспий',
];
